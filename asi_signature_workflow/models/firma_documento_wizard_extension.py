    ...
    def default_get(self, fields_list):
        ...
        if context.get('from_workflow') and context.get('workflow_id'):
            ...
            if workflow.exists():
                ...
                _logger.info(f"Wizard de firma local configurado desde flujo {workflow.id} con rol {workflow.signature_role_id.name} y posición {workflow.signature_position}")
